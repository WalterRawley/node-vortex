...
(function() {
  ...
  DataReader = (function() {
    ...
    DataReader.prototype.close = function() {
      console.log("Closing DR " + this.eid);
      this.closed = true;
  ...
  DataWriter = (function() {
    ...
    DataWriter.prototype.close = function() {
      console.log("Closing DW " + this.eid);
      this.closed = true;
  ...
  DataCache = (function() {
    ...
    DataCache.prototype.removeListener = function(id) {
    ...
    DataCache.prototype.write = function(k, data) {
      ...
      for (id in this.listeners) {
        if (this.listeners[id].predicate(data) === true) {
          _results.push(this.listeners[id].listener(data));
        } else {
